  ...
  return (
    <div className="h-5/6 w-full ">
      <div className="h-4/6 w-full flex flex-wrap justify-center content-center">
        ...
        transition={{duration: 3.5 , type : 'spring' , stiffness : 200 , mass:4}}
        >
            Welcome To The World's One Of The Trusted Website
        </motion.h2>
        <NavLink to="/signup" className="h-16 w-1/6">
        ...
        transition={{delay:0.5, duration: 2 , type : 'spring' , stiffness : 150 , mass:2}}
        >
          Get Started
        </motion.p>
        </NavLink>
